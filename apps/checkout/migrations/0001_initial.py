    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("finalization_key", models.UUIDField(blank=True, null=True)),
                (
                    "status",
                    models.CharField(
                        choices=[
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("rate_bps__lte", 10000)),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        ...
                        name="checkout_zone_code_ci_unique",
                    ),
                    models.UniqueConstraint(
                        django.db.models.functions.text.Lower("country_code"),
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            ("city", ""), models.Q(("province", ""), _negated=True), _connector="OR"
                        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("checkout", "variant"), name="checkout_line_variant_unique"
                    ),
                    models.CheckConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("user", "idempotency_key"), name="checkout_user_create_key_unique"
            ),
        ),
        migrations.AddConstraint(
            model_name="checkoutsession",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("subtotal_toman__gte", 0)), name="checkout_subtotal_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="checkoutsession",
            constraint=models.CheckConstraint(
                condition=models.Q(("discount_toman__gte", 0)), name="checkout_discount_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="checkoutsession",
        ...
        migrations.AddConstraint(
            model_name="checkoutsession",
            constraint=models.CheckConstraint(
                condition=models.Q(("shipping_toman__gte", 0)), name="checkout_shipping_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="checkoutsession",
            constraint=models.CheckConstraint(
                condition=models.Q(("tax_toman__gte", 0)), name="checkout_tax_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="checkoutsession",
            constraint=models.CheckConstraint(
                condition=models.Q(("payable_toman__gte", 0)), name="checkout_payable_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="checkoutsession",
            constraint=models.CheckConstraint(
                condition=models.Q(("tax_rate_bps__lte", 10000)),
        ...
        migrations.AddConstraint(
            model_name="shippingmethod",
            constraint=models.UniqueConstraint(
                fields=("zone", "code"), name="checkout_method_zone_code_unique"
            ),
        ),
        migrations.AddConstraint(
            model_name="shippingmethod",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("free_over_toman__isnull", True), ("free_over_toman__gte", 0), _connector="OR"
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(
                        ("delivery_max_days__isnull", True), ("delivery_min_days__isnull", True)
                    ),
                    models.Q(
                        ("delivery_min_days__isnull", False),
                        ("delivery_max_days__isnull", False),
                        ("delivery_max_days__gte", models.F("delivery_min_days")),
                    ),
                    _connector="OR",
                ),
