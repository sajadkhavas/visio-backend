        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("event_hash", ""), _negated=True),
                        name="ops_audit_hash_nonempty",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    models.CharField(
                        choices=[("success", "Success"), ("failed", "Failed")], max_length=16
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="operations.notificationoutbox",
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("notification", "attempt_no"), name="ops_notify_attempt_unique"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("attempt_no__gt", 0)),
                        name="ops_notify_attempt_positive",
                    ),
                ],
            },
        ),
